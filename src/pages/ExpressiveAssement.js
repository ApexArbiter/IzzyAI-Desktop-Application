      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-0 overflow-hidden">
          <main className="flex flex-col h-full">
            ...
            <div className="flex flex-row justify-center items-start gap-12 ml-4 mt-4">
              {/* Camera View */}
              <div className="">
                ...
                <div className="flex flex-col h-full justify-end">
                  ...
                  {recordingStatus === 'idle' && isVideoEnd && (
                    <button
                      ...
                      className="w-full mt-24 rounded-full bg-slate-900 py-2 px-3 h-10 flex items-center justify-center mb-4 transition-all hover:bg-slate-800 active:bg-slate-700"
                    >
                  ...
                  {recordingStatus === 'recording' && (
                    <div className="border-2 border-red-500 mt-24 mb-4 p-1 rounded-full">
                      <button
