  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-2xl mx-auto px-4 py-2 space-y-3 lg:space-y-4">
          {/* Logo */}
          <div className="h-16 lg:h-20 w-40 mx-auto">
            <img
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-[#0cc8e81f] to-[#2deeaa1f] rounded-2xl px-4 py-4 lg:py-6"
          >
            <div className="flex items-center space-x-4">
              ...
              >
                <img
                  ...
                  alt="Profile"
                  className="w-16 lg:w-20 h-16 lg:h-20 rounded-full object-cover border-4 border-white shadow-lg"
                />
          ...
          {/* Menu Items */}
          <div className="space-y-2 lg:space-y-3 mb-16">
            {menuItems.map((item, index) => (
              <motion.div
                key={item.label}
                variants={itemVariants}
                className="flex items-center rounded-2xl bg-gradient-to-r from-[#0cc8e81f] to-[#2deeaa1f] justify-between p-3 lg:p-4 cursor-pointer"
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-base lg:text-lg font-medium text-gray-700">{item.label}</span>
                </div>
                <motion.div
                  whileHover={{ x: 5 }}
